...
function Manageusers() {
  ...
  const rows = [
    ...
    createData("Ben Fernandez", "305-245-5467", "Admin", 37, 4.3),
    createData("Carlos Hinojosa", "786-836-1234", "Admin", 24, 6.0),
    createData("David Miller", "305-247-1780", "Admin", 67, 4.3),
    createData("Elsy Lopez", "305-125-8325", "Admin", 49, 3.9),
  ];
